...
def SPARQLendpoint = "http://172.0.0.1:8081/blazegraph/namespace/replicate-mishel/sparql"
...
def CompleteGraphUri = "http://172.0.0.1:8081/blazegraph/namespace/replicate-mishel/sparql?context-uri=" + NamedGraph
