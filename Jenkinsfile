...
def SPARQLendpoint = "http://"+entornoBlaze+"/namespace/"+NameSpace+"/sparql"
    ...
    try {
        ...
        stage('Notify failure') {
            ...
            mail(to: 'dmuv7@hotmail.com',
                ...
                body: "Ha fallado la ejecución de '${env.JOB_NAME}', el error se ha dado en: " + date + ". Revisa el error en http://"+entorno+"/jenkins/job/Replicate-Donosti-BKLParkings/${env.BUILD_NUMBER}",
                mimeType: 'text/html');
